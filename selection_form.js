...
var tplay = "http://www.dia.uniroma3.it/~compunet/projects/radian/client/index_atlas_anchors.html";
...
function loadCities(probes, callback) {
	...
	$.getJSON(dia + "nearest-city?latitude=" + latitude.join(",") + "&longitude=" + longitude.join(","), function (data) {
		if (data.error != undefined) {
			console.error("Could not load cities", data.error);
		} else {
